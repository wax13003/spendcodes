...
contract MerchantPayment {
    ...
    function payOrder(uint256 orderId, string calldata metaData) external {
        ...
        require(usdcToken.transferFrom(msg.sender, owner, fee), "Transfer of fee failed");
        require(usdcToken.transferFrom(msg.sender, merchant, merchantAmount), "Transfer to merchant failed");
